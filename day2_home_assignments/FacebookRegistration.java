package week2.day2_home_assignments;
...
public class FacebookRegistration {
	...
	public static void main(String[] args) {
		...
		// enter first name
		driver.findElement(By.name("firstname")).sendKeys("Krishnaveni");

		// enter surname
		driver.findElement(By.name("lastname")).sendKeys("Ananth");
		...
		driver.findElement(By.name("reg_email__")).sendKeys("veni3093@gmail.com");

		// enter password
		driver.findElement(By.id("password_step_input")).sendKeys("Aarush@18");
